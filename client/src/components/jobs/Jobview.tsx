...
// }, [jobs,searchTerm]);
    ...
    return (
        <div>
            ...
            {jobs && jobs.length > 0 ? (
                 jobs.map((job) => (
                <div key={job._id} className='group group/item singleJob w-[250px] p-[20px] bg-white rounded-[10px] hover:bg-blueColor shadow-lg shadow-greyish-400/700 hover:shadow-lg'  onClick={()=>selectJob(job)} >
